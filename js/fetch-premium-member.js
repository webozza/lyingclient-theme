			  ...
			  <div class="business_contact_info_div">
				  <div class="business_contact_info_div_flex">
					  ...
					  <div class="business_contact_info">
						  ...
						  <p class="business_location">${user.clients_zip_code} ${user.business_name}</p>
					  </div>
				  </div>
...
// FOR CLIENT DIR SEARCH
if($('#client-experience-details img').attr('src').indexOf('no.png') > -1 && window.location.href.indexOf('/?experience_slug') ) { // IF NO ATTACHMENT AND IF CLIENT EXP URL
    $('.attachment_div').hide();
}
