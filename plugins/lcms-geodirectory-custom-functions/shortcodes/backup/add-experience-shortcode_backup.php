	...
	if (
		...
		$html = '
					<div id="my-client-experience-container" style="margin: 2rem 0;">
						<h1 style="font-size:2rem;color: var(--ast-global-color-2); font-weight: 500;">' . __('List a Client', 'lcms-geodirectory-custom-functions') . '</h1>
...
<div class="client-input-error" style=""><p style="">Something Went Wrong!</p></div>';
		...
		$html .= '</select>
									...
									<div class="form-group row mt-2 mb-2">
										<label for="exp_add_client_name" class="col-sm-3 col-form-label" >' . __('Client\'s Name', 'lcms-geodirectory-custom-functions') . '<span class="text-danger">*</span></label>
										<input class="col-sm-4" type="text" name="exp_add_client_name" id="exp_add_client_name" class="form-control" required>
									</div>
									<div class="form-group row mt-2 mb-2">
										<label for="exp_add_client_phone_number" class="col-sm-3 col-form-label" >' . __('Client\'s Phone Number', 'lcms-geodirectory-custom-functions') . '</label>
											<input class="col-sm-4" type="text" name="exp_add_client_phone_number" id="exp_add_client_phone_number" class="form-control">
									</div>
									<div class="form-group row mt-2 mb-2">
										<label for="exp_add_client_email" class="col-sm-3 col-form-label" >' . __('Client\'s Email', 'lcms-geodirectory-custom-functions') . '<span class="text-danger">*</span></label>
										<input class="col-sm-4" type="email" name="exp_add_client_email" id="exp_add_client_email" class="form-control" required>
									</div>
									<div class="form-group row mt-2 mb-2">
										<label for="exp_add_client_zipcode" class="col-sm-3 col-form-label" >' . __('Client\'s Zip Code', 'lcms-geodirectory-custom-functions') . '<span class="text-danger">*</span></label>
		...
		<div class="col-md-4 exp_add_client_attachement_div">
			<h2 style="font-size:1.3rem;" class="mt-4">' . __('Upload Attachment', 'lcms-geodirectory-custom-functions') . '</h2><p>(Optional)</p>
		...
		<a class="btn btn-primary exp_add_client_attachement_addon mt-5">' . __('Add New Attachment', 'lcms-geodirectory-custom-functions') . '</a>
								...
								<a class="btn btn-primary btnPrevious mt-5">' . __('Back', 'lcms-geodirectory-custom-functions') . '</a>
								<p style="margin-top:30px;clear:left;"><button class="btn bsui btn-primary" name="submit_button" value="save_experience">' . __('Submit Client', 'lcms-geodirectory-custom-functions') . '</button></p>
							</div> <!--tab pane -->
