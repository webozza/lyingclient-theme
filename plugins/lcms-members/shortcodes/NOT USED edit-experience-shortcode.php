...
add_shortcode('dbase_edit_experience_page', 'dbase_edit_experience_page_shortcode'); 
function dbase_edit_experience_page_shortcode( $atts ) {
	...
	if ( !isset($_GET['experience_slug']) ) {
		...
		'<p style="font-size:0.8rem;margin-top:15px;">'.__( 'No client experience was selected.','d-base-geodirectory-custom-functions').'</p>'.
		'</div>';
	}
	...
	/** Check if current user owns this experience record otherwise exit with message **/
		...
		if ( $current_user_id != $client_experience_check[0]->post_author ) {
			return
				'<div style="margin: 2rem 0;">'.
				'<h1 style="font-size:1.75rem;margin-bottom:20px;color: var(--ast-global-color-2); font-weight: 500;">'.__('Client Experience','d-base-geodirectory-custom-functions').'</h1>'.
				'<p style="font-size:0.8rem;margin-top:15px;">'.__( 'You do not have permission to edit this client experience.','d-base-geodirectory-custom-functions').'</p>'.
				'</div>';
		}

	/** Check MEMBERSHIP LEVEL **/
		$message = '<p>'.__('You do not have the correct membership to edit this client experience.','d-base-geodirectory-custom-functions').'</p>';
	...
	// DISPLAY the form
		...
		if ( $membership_level == 'premium' || $membership_level == 'plus' ) {
			$html = '
					<div style="margin: 2rem 0;">
						<h1 style="font-size:2rem;color: var(--ast-global-color-2); font-weight: 500;">'.__('Edit My Client Experience','d-base-geodirectory-custom-functions').'</h1>
						...
						<form method="post">';
							...
							/*<div class="form-group row mt-2 mb-2">
								<label for="exp_edit_member_name" class="col-sm-3 col-form-label" >Member Name<span class="text-danger">*</span></label>
									<input class="col-sm-4" value="'.__($client_experience[0]->member_name,'d-base-geodirectory-custom-functions').'" type="text" name="exp_edit_member_name" id="exp_edit_member_name" class="form-control" required>
							</div>
							<div class="form-group row mt-2 mb-2">
								...
								<input class="col-sm-4" value="'.__($client_experience[0]->business_name,'d-base-geodirectory-custom-functions').'" type="text" name="exp_edit_member_business_name" id="exp_edit_member_business_name" class="form-control" required>
							...
							<div class="form-group row mt-2 mb-2">
								...
								<input
									...
									$html .= ' class="col-sm-4" value="'.__($client_experience[0]->website,'d-base-geodirectory-custom-functions').'" type="url" name="exp_edit_member_website" id="exp_edit_member_website" class="form-control">';
							...
							*/
							$html .= '<div class="form-group row mt-2 mb-2">
								...
								<input class="col-sm-4" value="'.__($client_experience[0]->post_title,'d-base-geodirectory-custom-functions').'" type="text" name="exp_edit_client_name" id="exp_edit_client_name" class="form-control" required>
							</div>
							<div class="form-group row mt-2 mb-2">
								<label for="exp_edit_client_phone_number" class="col-sm-3 col-form-label" >Client\'s Phone Number</label>
									<input class="col-sm-4" value="'.__($client_experience[0]->clients_phone_number,'d-base-geodirectory-custom-functions').'" type="text" name="exp_edit_client_phone_number" id="exp_edit_client_phone_number" class="form-control">
							</div>
							<div class="form-group row mt-2 mb-2">
								<label for="exp_edit_client_email" class="col-sm-3 col-form-label" >Client\'s Email<span class="text-danger">*</span></label>
								<input class="col-sm-4" value="'.__($client_experience[0]->clients_email,'d-base-geodirectory-custom-functions').'" type="email" name="exp_edit_client_email" id="exp_edit_client_email" class="form-control" required>
							</div>
							<div class="form-group row mt-2 mb-2">
								<label for="exp_edit_client_zipcode" class="col-sm-3 col-form-label" >Client\'s Zip Code<span class="text-danger">*</span></label>
								<input class="col-sm-4" value="'.__($client_experience[0]->clients_zip_code,'d-base-geodirectory-custom-functions').'" type="text" name="exp_edit_client_zipcode" id="exp_edit_client_zipcode" class="form-control" required>
							</div>
							<div class="form-group row mt-2 mb-2">
							...
							<div class="form-group row mt-2 mb-2">
								...
								<input class="col-sm-4" value="'.__($client_experience[0]->clients_experience_rating,'d-base-geodirectory-custom-functions').'" type="text" name="exp_edit_client_experience_rating" id="exp_edit_client_experience_rating" class="form-control" required>
							</div>

							<p style="margin-top:30px;clear:left;"><button class="btn bsui btn-primary" name="submit_button" value="save_experience">'.__('Save','d-base-geodirectory-custom-functions').'</button></p>
			...
			$html = '
					<div style="margin: 2rem 0;">
						<h1 style="font-size:1.75rem;margin-bottom:20px;color: var(--ast-global-color-2); font-weight: 500;">'.__('Edit My Client Experience','d-base-geodirectory-custom-functions').'</h1>
						<p style="font-size:0.8rem;margin-top:15px;">'.__('We have no result for this client experience entry. Contact the website administrator.','d-base-geodirectory-custom-functions').'</p>
					</div>
					';
		}
