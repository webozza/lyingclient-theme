...
add_shortcode('dbase_admin_approve_experience_page', 'dbase_admin_approve_experience_page_shortcode'); 
function dbase_admin_approve_experience_page_shortcode( $atts ) {
	...
	// DISPLAY the form
		...
		$html = '
				<div style="margin: 2rem 0;">
					<h1 style="font-size:2rem;color: var(--ast-global-color-2); font-weight: 500;">'.__('Client Experience Approval','d-base-geodirectory-custom-functions').'</h1>
