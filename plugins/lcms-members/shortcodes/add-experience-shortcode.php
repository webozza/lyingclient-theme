	...
	if (
		...
		$html = '
					<div id="my-client-experience-container" style="margin: 2rem 0;">
						<h1 style="font-size:2rem;color: var(--ast-global-color-2); font-weight: 500;">' . __('Share Your Experience', 'd-base-geodirectory-custom-functions') . '</h1>
...
<div class="client-input-error" style=""><p style="">Something Went Wrong!</p></div>';
			...
			<div class="row experience-form">
				<div class="col-sm-6">
					<div class="form-group row mt-2" style="margin-right:20px;margin-left: 0px;">
						<label for="exp_add_client_name" class="col-form-label" >' . __('Client\'s Name', 'd-base-geodirectory-custom-functions') . '<span class="text-danger">*</span></label>
				...
				<div class="col-sm-6">
					<div class="form-group row mt-2" style="margin-right:20px;">
						<label for="exp_add_client_phone_number" class="col-form-label" >' . __('Client\'s Phone Number', 'd-base-geodirectory-custom-functions') . '</label>
			...
			<div class="row experience-form">
				<div class="col-sm-6">
					<div class="form-group row" style="margin-right:20px;margin-left: 0px;">
						<label for="exp_add_client_email" class="col-form-label" >' . __('Client\'s Email', 'd-base-geodirectory-custom-functions') . '<span class="text-danger">*</span></label>
				...
				<div class="col-sm-6">
					<div class="form-group row" style="margin-right:20px;">
						<label for="exp_add_client_zipcode" class="col-form-label" >' . __('Client\'s Zip Code', 'd-base-geodirectory-custom-functions') . '<span class="text-danger">*</span></label>
		...
		<div class="col-md-4 exp_add_client_attachement_div">
			<h2 style="font-size:1.3rem;" class="mt-4">' . __('Upload Attachment (Optional)', 'd-base-geodirectory-custom-functions') . '</h2>
		...
		<a class="btn btn-primary exp_add_client_attachement_addon mt-5">' . __('Add New Attachment', 'd-base-geodirectory-custom-functions') . '</a>
								...
								<div><a class="btn btn-primary btnPrevious mt-5">' . __('Back', 'd-base-geodirectory-custom-functions') . '</a>
								<button class="btn bsui btn-primary" name="submit_button" value="save_experience">' . __('Submit Client', 'd-base-geodirectory-custom-functions') . '</button></div>
							</div> <!--tab pane -->
